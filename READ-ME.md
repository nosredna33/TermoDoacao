...
Sistema completo de gerenciamento de termos de entrega de equipamentos para municípios 
brasileiros com geração de PDF, assinatura digital via GOV.BR e upload de termos assinados.

Feito 80% com Manus IA e 20% da minha genialidade para conduzí-la! Pareto, Pareto, seu fanfarrão...

IA é bom, mas não faz nada sozinho, Só com um gênio por traz, para fazer tudo em 3 hors. Sendo, 
1 para o prompt e 2 para para corrigir os devaneios da IA. Agora está aí, pronto....

# Autores:
* Anderson Luís Oliveira e Silva: Criação do prompt + IAs + Cartão de crédito - R$ 250,00 
* Ivan Ribeiro: Avaliação de qualidade, Testes e mão na massa
...
O banco de dados já vem com **103 termos de exemplo** de diversas regiões do Brasil:
...
- **Monitoramento:** http://localhost:8080/admin/monitor/
...
│   │           ├── monitor/     # Templates da página de monitoração
...
- Fazer login: admin@saude.gov.br / Admin@123456
...
8. **Monitoração:** A versão 1.0.5 ganhou uma página amigável para visualização dos 
indicadores de desmpenho geradas pelo Actuator
...
---
## Links que apoiaram este projeto

| Descrição do Apoio | Link |
| --- | --- |
| Geração de Banner                  | https://manytools.org/hacker-tools/ascii-banner/ |
| Editor Markdown                    | https://stackedit.io/ |
| Markdown para Word                 | https://mconverter.eu/convert/markdown/docx/ |
| Gerador de CPF e CNPJ              | https://www.4devs.com.br/gerador_de_cpf |
| DeepSeek - Elaboração do Prompt    | https://chat.deepseek.com/ |
| Gemini - Refinamento do Prompt     | https://gemini.google.com/ | 
| ChatGPT - Verificação final        | https://chatgpt.com/ |
| Manus - Implementação da Aplicação | https://manus.im/app | 
| GitHub - Publicação da Aplicação   | https://github.com/nosredna33/TermosDoacoes | 
